...
class NETBOX:
    ...
    def __init__(self):
        self.NET = {
            ...
            1: PPOModel(name="VCTLevel", NubPhyPara=3, NubComPara=2, NubTimeSeq=15, ClipNetOut=[-1.0, 1.0], ActCase=20),
            2: PPOModel(name="PZRLevel", NubPhyPara=3, NubComPara=2, NubTimeSeq=15, ClipNetOut=[-1.0, 1.0], ActCase=20),
            3: PPOModel(name="PZRpressure", NubPhyPara=3, NubComPara=2, NubTimeSeq=15, ClipNetOut=[-1.0, 1.0], ActCase=20),
