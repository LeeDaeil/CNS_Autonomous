...
class ENVCNS(CNS):
    ...
    def send_act(self, A):
        ...
        if self.accident_name == 'LOCA':
            ...
            # 17.2
            if self.get_CNS_time() == self.FixedRad + 1750: self.s_val(['KWSO208'], [1])
            ...
            # 17.2
            if self.get_CNS_time() == self.FixedRad + 1400: self.s_val(['KWSO208'], [1])
        ...
        print(self.logicpara, self.logicval)
        if self.logicpara != []:
