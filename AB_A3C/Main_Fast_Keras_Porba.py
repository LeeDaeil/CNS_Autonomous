...
MAKE_FILE_PATH = f'./AB_DB/VER_0_{get_file_time_path.month}_{get_file_time_path.day}_{get_file_time_path.minute}_{get_file_time_path.second}'
...
class MainModel:
    ...
    def run(self):
        ...
        while True:
            ...
            # 모델 save
            if count == 60:
                self.main_net.save_model('AB_Controller')
                count %= 60
            count += 1
