        ...
        for eps in range(max_episodes):
            ...
            for step in range(max_steps):
                ...
                fig_db = {
                    ...
                    'PZRLevl': env.CMem.PZRLevl,
                    'FV122': env.CMem.FV122,
                    'HV142': env.CMem.HV142,
                    'PZRSpray': env.CMem.PZRSprayPos,
                    'PZRTemp': env.CMem.PZRTemp,
                    'ExitCoreT': env.CMem.ExitCoreT,
                }
                TFig.add_fig_mem(fig_db)
