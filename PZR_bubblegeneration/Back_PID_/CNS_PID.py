...
class AnimationWidget(QWidget):
    ...
    def update_line(self, i):
        ...
        # self.hv_position.append(pos3) # hv603 valve position list
        ...
        if i <= 70:
            print(i, valve_control, pres, error_pres, rcs_temp, prz_level, valve)
...
if __name__ == '__main__':
    ...
    aw = AnimationWidget(ip='192.168.44.1', port=7000, cns_ip='192.168.44.128', cns_port=7001, kp=0.03, ki=0.001, kd=1.0)
    sys.exit(qApp.exec_())
